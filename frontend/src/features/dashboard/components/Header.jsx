import WebNameIcon from "../../../shared/icons/IconPage";

function Header() {
  return (
    <header className="site-header sticky-top">
      <nav className="container-xl navbar d-flex flex-wrap gap-2 py-3">
        <a className="navbar-brand brand-mark d-flex align-items-center gap-2 m-0" href="#intro">
          <WebNameIcon />
        </a>
        ...
        <div className="d-flex gap-2 ms-auto order-2 order-lg-3">
          ...
          <a className="btn btn-dark rounded-pill fw-bold px-3" href="/register">Đăng kí</a>
        </div>
      </nav>
    </header>
  );
